...
static struct retro_core_option_definition option_defs_us[] =
  {
    ...
    },
    {
      "opera_lg_x_offset",
      "Lightgun X Offset",
      "Manually adjust the X offset of lightgun shots to avoid the need for in-game calibration.",
      {
        { "-30", NULL },
        { "-29.5", NULL },
        { "-29", NULL },
    ...
    },
    {
      "opera_lg_y_offset",
      "Lightgun Y Offset",
      "Manually adjust the Y offset of lightgun shots to avoid the need for in-game calibration.",
      {
        { "-30", NULL },
        { "-29.5", NULL },
        { "-29", NULL },
